...
# =====================================================================
PRINCIPLES = """- REMOVE only for unambiguous violations: exposure of a PRIVATE person's data
  (doxxing), credible threats, or clearly illegal content. Stated intent
  ("just a joke") does not excuse doxxing.
